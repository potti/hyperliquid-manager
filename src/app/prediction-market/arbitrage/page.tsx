...
type PlatformFilter = 'all' | 'polymarket' | 'predict'
...
function liquidityLabel(eventKey: string, map: Map<string, PMMarket>): string {
  ...
  return `P:${p.toFixed(0)} / Pred:${pr.toFixed(0)}`
}
...
export default function ArbitragePage() {
  ...
  const columns: ColumnsType<ArbOpportunity> = [
    ...
    },
    {
      title: 'Poly NO',
      key: 'pn',
      render: (_, r) => legPrice(r, 'polymarket', 'NO').toFixed(4),
    },
    {
      title: 'Predict YES',
      key: 'pry',
    ...
    },
    {
      title: 'Predict NO',
      key: 'prn',
      render: (_, r) => legPrice(r, 'predict', 'NO').toFixed(4),
    },
    {
      title: 'Spread(净)',
